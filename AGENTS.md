...
## Repository Overview
This repository currently contains **3078** working code examples across **17** categories.
...
- **working-with-outlook-items** — 513 examples. Guide: [AGENTS.md](./working-with-outlook-items/AGENTS.md)
