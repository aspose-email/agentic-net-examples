...
| [implement-a-googleuser-class-that-handles-oauth-2-0-authentication-flows-and-token-management-including-token-acquisition-refresh-and-user-profile-retrieval.cs](./implement-a-googleuser-class-that-handles-oauth-2-0-authentication-flows-and-token-management-including-token-acquisition-refresh-and-user-profile-retrieval.cs) | implement a googleuser class that handles oauth 2 0 authentication flows and token management including token acquisition refresh and user profile retrieval |
