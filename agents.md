...
## Repository Overview
This repository currently contains **2719** working code examples across **17** categories.
...
- **working-with-outlook-items** — 438 examples. Guide: [agents.md](./working-with-outlook-items/agents.md)
